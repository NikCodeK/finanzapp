...
import { PencilIcon, TrashIcon, CheckCircleIcon, PauseCircleIcon } from '@heroicons/react/24/outline';
...
export default function GoalCard({
  ...
  const isOnTrack = () => {
    ...
    const actualProgress = range > 0 ? (goal.currentAmount - goal.startAmount) / range : 0;
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 text-sm">
        ...
        <div>
          <p className="text-slate-500">Startbetrag</p>
